  ...
  return (
    <section id="home" className="flex flex-col md:flex-row items-center justify-between p-8 bg-gray-100">
      <div className="md:w-1/2">
        <h2 className="text-4xl font-bold text-gray-800">Welcome to StychWFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFBrand</h2>
